...
PINS = [
 ("london","London","United Kingdom",51.5074,-0.1278,"active","places",1,"real",
  "Western departure point for the eastern theater. Heathrow carries the outbound traffic toward Poland and the frontier.",0,-14,"middle"),
 ...
 ("lublin","Lublin","Poland",51.2465,22.5684,"fortified","places",2,"real",
  "Heavily militarized Polish city well behind the frontier: watchtowers, rail-fed artillery, and autonomous air defense. Supports Allied command and communications.",0,0,"middle"),
 ("rzeszow","Rzeszów","Poland",50.0413,21.9990,"active","places",2,"real",
  "Polish transportation gateway on the S19 corridor, moving people and freight toward the Ukrainian frontier.",0,0,"middle"),
 ("medyka","Camp Tadeusz","Medyka, Poland",49.8060,22.9250,"active","places",2,"fictional",
  "NATO-aligned volunteer training and staging camp on the Polish side of the frontier, beside the former border crossing at Medyka.",0,0,"middle"),
 ...
 ("kyiv","Kyiv","Ukraine",50.4501,30.5234,"unknown","places",1,"real",
  "Ukrainian capital astride the Dnipro and a central anchor of the Eastern Front. Independence Square sits at its civic center. Occupied; conditions unreported.",10,5,"start"),
 ("odesa","Odesa","Ukraine",46.4825,30.7233,"unknown","places",1,"real",
  "Black Sea port city of broad streets and arcades, backed by docks, container yards, and rail. Occupied; conditions unreported.",-10,3,"end"),
 ("moscow","Moscow","Russia",55.7558,37.6173,"hostile","places",1,"real",
  "Russian capital and the western terminus of the reconstructed east-west rail network. Ringed by depots, transfer stations, and checkpoints.",0,-14,"middle"),
...
LINES = [
 ("eastern-corridor","The Eastern Corridor","infrastructure","fictional","rail",
  "Transcontinental high-speed rail under Chinese-administered reconstruction, advertised as Construction Phase IV of XII. Its eastern terminus lies beyond the edge of this sheet; the corridor is identified there by Chinese signage and is not named.",
 ...
 ("corridor-projected","Eastern Corridor — Advertised Extension","infrastructure","fictional","rail-planned",
  "Projected continuation toward Warsaw and western Europe, as depicted in the corridor's own advertising. No track exists west of the front.",
  [P(52.10,23.70),P(52.23,21.01)]),
 ("air-route","London – Rzeszów Air Route","infrastructure","real","air",
  "Scheduled westbound-to-frontier air link, the standard approach for personnel and freight entering the theater.",
...
AREAS = [
 ("depopulated-belt","Depopulated Reconstruction Belt","DEPOPULATED BELT","infrastructure","fictional",
  "Former population centers remain marked on official maps despite large-scale depopulation.",
 ...
 ("reconstruction-zone","Eastern Corridor Reconstruction Zone","RECONSTRUCTION ZONE","infrastructure","fictional",
  "Repaired roads, transfer stations, water towers, construction yards, prefab housing, and customs infrastructure tracking the rail axis. Signage is largely in Mandarin.",
 ...
 ("still-earth","Sterilized Agricultural Belt","STILL EARTH","military","fictional",
  "Farmland deliberately rendered unusable. Officially recorded as arable; nothing has been grown here for years.",
  [P(50.6,26.2),P(50.2,29.6),P(48.4,29.9),P(47.6,27.4),P(48.6,25.4)],
  P(48.5,27.6),"middle"),
 ("medyka-sector","Medyka Front Sector","","military","fictional",
  "Localized military district around the former border crossing: covered roads, ruined rail, defensive belts, and layered drone defenses.",
...
LAYERS = [
 ...
 ("military","Military Geography","Corridors, sectors, and overlays"),
